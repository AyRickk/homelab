resource "proxmox_vm_qemu" "valaskjalf_master_3" {
  # === Basic VM Configuration ===
  name        = "valaskjalf-master-3"
  description = "Production rke2 master 3, Master Node, Ubuntu LTS"
  vmid        = 1003
  target_node = "asgard"
  ...
  # Static IP configuration: 10.10.10.103/24 with gateway 10.10.10.1
  # Master nodes should always have static IPs for cluster stability
  ipconfig0  = "ip=10.10.10.103/24,gw=10.10.10.1"
