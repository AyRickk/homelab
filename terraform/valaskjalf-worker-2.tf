resource "proxmox_vm_qemu" "valaskjalf_worker_2" {
  # === Basic VM Configuration ===
  name        = "valaskjalf-worker-2"
  description = "Production rke2 worker 2, Worker Node, Ubuntu LTS"
  vmid        = 1012
  target_node = "asgard"
  ...
  # Static IP configuration: 10.10.10.112/24 with gateway 10.10.10.1
  ipconfig0  = "ip=10.10.10.112/24,gw=10.10.10.1"
